...
customer_demographics_fv_v2 = FeatureView(
...
customer_financials_fv_v2 = FeatureView(
    name="customer_financials_v2",
    entities=[customer],
...
customer_contract_fv_v2 = FeatureView(
    name="customer_contract_v2",
    entities=[customer],
    ttl=timedelta(days=365),
    schema=[
